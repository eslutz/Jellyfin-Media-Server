...
See [../docs/jellyfin-media-server/configuration-plan.md](../docs/jellyfin-media-server/configuration-plan.md) for detailed configuration recommendations.
...
- **[Configuration Guide](../docs/jellyfin-media-server/configuration-guide.md)** - Complete usage documentation
- **[Configuration Plan](../docs/jellyfin-media-server/configuration-plan.md)** - Recommended library settings
...
See the included `jellyfin.config.json` for a complete example.
